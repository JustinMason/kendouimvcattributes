...
namespace KendoUIMvcAttributes
{
    ...
    public class KendoComboBoxAttribute : Attribute, IMetadataAware
    {
        ...
        public KendoComboBoxAttribute(string action, string controller)
        {
            Action = action;
        ...
        {
            metadata.TemplateHint = "KendoComboBox";
